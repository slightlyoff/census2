This is v2 of the Census RIA benchmarking application. Java 1.5 or better is
required. A web server is included in the distribution of the benchmark and no
